  ...
  <div class="page-shell">
    <nav class="navbar glass" aria-label="Navigasi utama">
      ...
      <div class="nav-actions">
        ...
        <a class="nav-chip" href="privacy.php"><i class="fa-solid fa-shield-halved"></i> Privasi</a>
    ...
    <main>
      <section class="hero">
        <div class="hero-panel glass">
          <div class="hero-copy">
            <span class="hero-chip"><i class="fa-solid fa-file-contract"></i> Syarat layanan</span>
            ...
            <div class="hero-actions">
              <a class="btn btn-primary" href="privacy.php"><i class="fa-solid fa-shield-halved"></i> Lihat Privasi</a>
        ...
        <aside class="hero-aside">
          <div class="aside-card glass">
            ...
            <div class="note">
              <p>Aturan ini dapat diperbarui saat dibutuhkan untuk menyesuaikan operasional, regulasi, atau peningkatan kualitas layanan.</p>
            </div>
          </div>
        </aside>
      </section>
      ...
      <section class="section glass">
        <div class="section-header">
          <span class="hero-chip"><i class="fa-solid fa-scale-balanced"></i> Ringkasan ketentuan</span>
          <h2 class="section-title">Hal-hal utama yang perlu dipahami</h2>
          <p class="section-copy">Poin-poin berikut membantu pelanggan memahami bagaimana layanan digunakan, dibayar, dan dihentikan bila perlu.</p>
        </div>
        ...
        <div class="list">
          <div class="list-item">
            ...
            <div>
              <strong style="display:block; color:var(--dark); margin-bottom:4px;">Keterlambatan tagihan</strong>
              <span>Layanan dapat dibatasi sementara jika tagihan melewati jatuh tempo.</span>
            </div>
          </div>
          <div class="list-item">
            <i class="fa-solid fa-circle-check"></i>
            <div>
              <strong style="display:block; color:var(--dark); margin-bottom:4px;">Pelanggaran penggunaan</strong>
              <span>Aktivitas ilegal, penyalahgunaan jaringan, atau tindakan yang merugikan pihak lain tidak diperbolehkan.</span>
            </div>
          </div>
        </div>
        ...
        <div class="callout">
          <div>
            <strong style="display:block; font-size:1.06rem; color:var(--dark); margin-bottom:6px;">Perlu penjelasan lebih lanjut?</strong>
            <p style="margin:0;">Silakan hubungi tim kami melalui halaman kontak di beranda jika ada bagian ketentuan yang ingin dikonfirmasi.</p>
          </div>
