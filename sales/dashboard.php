...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin-bottom: 30px;">
    <!-- Deposit Card -->
    <div class="card" style="background: var(--bg-primary); border-color: var(--neon-cyan);">
        <div class="card-body" style="padding: 25px;">
            <h5 style="color: var(--text-secondary); margin-bottom: 10px; font-size: 1rem;">Saldo Deposit</h5>
            <h2 style="font-size: 2.5rem; color: var(--text-secondary); margin-bottom: 5px;"><?php echo formatCurrency($salesUser['deposit_balance']); ?></h2>
