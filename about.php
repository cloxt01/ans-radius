...
$pageDescription = 'Profil perusahaan, nilai layanan, dan komitmen ANS RADIUS kepada pelanggan.';
  ...
  <div class="page-shell">
    <nav class="navbar glass" aria-label="Navigasi utama">
      ...
      <div class="nav-actions">
        <a class="nav-chip" href="voucher-order.php"><i class="fa-solid fa-ticket"></i> Voucher</a>
        <a class="nav-chip" href="index.php#contact"><i class="fa-solid fa-phone"></i> Kontak</a>
    ...
    <main>
      <section class="hero">
        <div class="hero-panel glass">
          <div class="hero-copy">
            <span class="hero-chip"><i class="fa-solid fa-wave-square"></i> Tentang kami</span>
            <h1>Internet yang stabil, layanan yang jelas, dan dukungan yang cepat.</h1>
            <p class="lead">ANS RADIUS dibangun untuk membantu pelanggan mendapatkan koneksi internet yang andal sekaligus pengalaman layanan yang sederhana, responsif, dan transparan dari awal pemasangan sampai penggunaan harian.</p>
            <div class="hero-actions">
              <a class="btn btn-primary" href="index.php#packages"><i class="fa-solid fa-layer-group"></i> Lihat Paket</a>
              <a class="btn btn-secondary" href="privacy.php"><i class="fa-solid fa-shield-halved"></i> Kebijakan Privasi</a>
            </div>
          </div>
        </div>
        ...
        <aside class="hero-aside">
          <div class="aside-card glass">
            ...
            <p>Kami memprioritaskan koneksi yang konsisten, proses yang mudah dipahami, dan bantuan teknis yang cepat saat pelanggan membutuhkannya.</p>
            <div class="stat-list">
      ...
      <section class="section glass">
        <div class="section-header">
          <span class="hero-chip"><i class="fa-solid fa-star"></i> Nilai layanan</span>
          <h2 class="section-title">Prinsip yang kami jaga setiap hari</h2>
          <p class="section-copy">Halaman ini merangkum cara kami bekerja: membangun jaringan yang dapat diandalkan, memberikan bantuan yang cepat, dan menjaga informasi layanan tetap terbuka.</p>
        </div>
        ...
        <div class="callout">
          <div>
            <strong style="display:block; font-size:1.06rem; color:var(--dark); margin-bottom:6px;">Butuh bantuan lebih lanjut?</strong>
            <p style="margin:0;">Kunjungi halaman kontak di beranda untuk menghubungi tim kami atau meninjau layanan yang tersedia.</p>
          </div>
          <a class="pill" href="index.php#contact"><i class="fa-solid fa-arrow-right"></i> Ke halaman kontak</a>
        </div>
      </section>
    </main>
