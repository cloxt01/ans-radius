                        ...
                        <tr
                            ...
                            <td data-label="Aksi">
                                <div style="display: flex; gap: 5px;">
                                    ...
                                    <form method="POST" data-no-loading="true" onsubmit="return confirm('Hapus router ini?')">
            ...
            <form method="POST" id="routerForm">
                ...
                <div class="row" style="display: flex; gap: 15px;">
                    <div class="form-group" style="flex:1;">
                        ...
                        <input type="text" name="username" id="routerUser" class="form-control" placeholder="Contoh: admin" required>
                    </div>
                    <div class="form-group" style="flex:1;">
                        <label class="form-label">Password</label>
                        <input type="password" name="password" id="routerPass" class="form-control" placeholder="Masukkan password">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="routerDesc" class="form-control" rows="2" placeholder="Deskripsi router (opsional)"></textarea>
                </div>
