                ...
                <tr>
                    ...
                    <td data-label="Aksi">
                        <div style="display: flex; gap: 5px;">
                            ...
                            <form method="POST" data-no-loading="true" onsubmit="return confirm('Hapus teknisi ini?');">
    ...
    <div class="modal-content">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" minlength="3" placeholder="Contoh: Sarmin" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="username" class="form-control"  minlength="3" pattern="[a-zA-Z0-9_]+" title="Hanya huruf, angka, dan underscore" autocomplete="username" required>
            </div>
            
            <div class="form-group">
                <label class="form-label">Password</label>
                <input type="password" name="password" class="form-control" minlength="6" autocomplete="new-password" placeholder="Minimal 6 karakter" required>
            </div>
