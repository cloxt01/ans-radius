...
<div class="card">
    ...
    <form data-no-loading="true" id="generateForm">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            <div class="form-group">
                ...
                <select name="profile" id="voucherProfile" class="form-control" required style="background: var(--light); color: var(--text-primary); padding: 12px; border: 1px solid #2a2a40; border-radius: 8px; font-size: 1rem; width: 100%;">
...
#voucherProfile option {
    background: #0f1220;
    color: #e5e7eb;
    padding: 10px;
}

#voucherProfile option:checked {
