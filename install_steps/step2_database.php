...
<form method="POST" action="install.php?step=2">
    ...
    <div class="form-group">
        <label for="rad_db_name">Database RADIUS Name</label>
        <input type="text" id="rad_db_name" name="rad_db_name" placeholder="radius_db_name" required>
        <small style="color: #666;">Nama database RADIUS yang sudah dibuat di cPanel/phpMyAdmin</small>
