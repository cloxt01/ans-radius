    ...
    <section class="packages" id="packages">
        ...
        <div class="package-grid">
            ...
            <div class="package-card">
                ...
                <br>
                <a href="?reg=open&pkg=<?php echo rawurlencode((string) $pkg['name']); ?>#register" class="btn btn-primary" style="background: var(--primary); color: #fff;" onclick="try { window.__gembokOpenRegisterModalWithPackage && window.__gembokOpenRegisterModalWithPackage(<?php echo json_encode((string) $pkg['name']); ?>); return false; } catch (e) { return true; }">Pilih Paket</a>
            </div>
            <?php endforeach; ?>
        </div>
    </section>
